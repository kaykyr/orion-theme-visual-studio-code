 ...
 * @prop {Record<'base'|'ansi'|'brightOther'|'other', string[]>} orion - Orion color variables.
...
const transformSoft = theme => {
    ...
    const brightColors = [...soft.orion.ansi, ...soft.orion.brightOther];
